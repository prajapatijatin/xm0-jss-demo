...
import NovenaLayout from 'src/NovenaLayout';
import {
  RenderingType,
  SitecoreContext,
      ...
      >
        ...
        */}
        {isComponentRendering ? (
          ...
          <>
            <NovenaLayout layoutData={layoutData} />
          </>
        )}
      </SitecoreContext>
    </ComponentPropsContext>
...
export const getStaticProps: GetStaticProps = async (context) => {
  if (!context.params) {
    ...
    if (context.params.path) {
      customPath = customPath.concat(context.params.path);
    }
    // console.log(customPath);
    context.params.path = customPath;
  }
